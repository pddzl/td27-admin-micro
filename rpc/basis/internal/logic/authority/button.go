...
func (bl *ButtonLogic) mapButtonToResp(button *authority.ButtonModel) *button_pb.ButtonResp {
	if button == nil {
		return nil
	}
...
func (bl *ButtonLogic) ListButton(in *common_pb.PageReq) (*button_pb.ListButtonResp, error) {
	...
	buttons, count, err := bl.svcCtx.ButtonService.List(bl.ctx, page, nil)
	if err != nil {
