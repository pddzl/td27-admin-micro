...
func (rl *RoleLogic) mapRoleToResp(role *authority.RoleModel) *role_pb.RoleResp {
	if role == nil {
		return nil
	}
...
func (rl *RoleLogic) mapRoleToTree(role *authority.RoleModel, allRoles []*authority.RoleModel) *role_pb.RoleTreeResp {
