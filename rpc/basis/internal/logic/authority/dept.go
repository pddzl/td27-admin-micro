...
func (dl *DeptLogic) mapDeptToResp(dept *authority.DeptModel) *dept_pb.DeptResp {
	if dept == nil {
		return nil
	}
...
func (dl *DeptLogic) mapDeptToTree(dept *authority.DeptModel, allDepts []*authority.DeptModel) *dept_pb.DeptTreeResp {
