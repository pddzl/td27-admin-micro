...
const (
	User_Login_FullMethodName            = "/basis.authority.user.User/Login"
	...
	User_AssignRoles_FullMethodName      = "/basis.authority.user.User/AssignRoles"
)
...
type UserClient interface {
	...
	GetUserInfo(ctx context.Context, in *common_pb.IdReq, opts ...grpc.CallOption) (*UserResp, error)
	...
	AssignRoles(ctx context.Context, in *AssignRolesReq, opts ...grpc.CallOption) (*common_pb.SuccessResp, error)
}
...
func (c *userClient) GetUserInfo(ctx context.Context, in *common_pb.IdReq, opts ...grpc.CallOption) (*UserResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResp)
...
func (c *userClient) AssignRoles(ctx context.Context, in *AssignRolesReq, opts ...grpc.CallOption) (*common_pb.SuccessResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(common_pb.SuccessResp)
...
type UserServer interface {
	...
	GetUserInfo(context.Context, *common_pb.IdReq) (*UserResp, error)
	...
	AssignRoles(context.Context, *AssignRolesReq) (*common_pb.SuccessResp, error)
...
func (UnimplementedUserServer) GetUserInfo(context.Context, *common_pb.IdReq) (*UserResp, error) {
...
func (UnimplementedUserServer) AssignRoles(context.Context, *AssignRolesReq) (*common_pb.SuccessResp, error) {
...
func _User_AssignRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).AssignRoles(ctx, req.(*AssignRolesReq))
	}
	return interceptor(ctx, in, info, handler)
}
